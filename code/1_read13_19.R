...
for (year in years) {
    ...
    print(glue('Fichero personal del {year} guardado'))
    ...
    print(glue('Fichero convivientes del {year} guardado'))
    ...
    df <- df[order(pid, firm_cc2, year)]
    saveRDS(df, glue('data/MCVL{year}COTIZA13.rds'))
    print(glue('Ficheros de cotizaciones del {year} guardados'))
    ...
    print(glue('Fichero de afiliacion del {year} guardado'))
